  ...
  if (validate_required(users_IMEI,"IMEI不能为空")==false)
	...
	<div id="main-content">
		<div class="content-box">
			...
			<form onsubmit="return validate_form(this);" action="<%=basePath %>admin/controller/addUser2" method="post" id="myform">
			  <p>
			  	<label>昵称</label>
              ...
              <p id="n_msg">
			  	<label>密码</label>
              	<input class="text-input small-input" type="password" id="small-input" name="users_password" id="pwd"/>
              	<small>(注意密码安全)</small> 
              </p>
              <p>
			  	<label>IMEI</label>
              	<input class="text-input small-input" type="text" id="small-input" name="users_IMEI" />
              	<small>(设备唯一标识码,软件登录界面可以查看)</small> 
              </p>
              <p>
              	<input class="text-input small-input" type="hidden" id="small-input" name="userGroup_id" value="4"/>
			  </p>
			  <!-- 
              <p>
	              <label>头像</label>
	              <input type="file" class="text-input small-input" id="small-input" name="users_face"/>
	              <small>(必填)</small> 
              </p>
               -->
	          <p>
