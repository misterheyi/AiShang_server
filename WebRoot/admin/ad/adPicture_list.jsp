  ...
  <div id="main-content">
	...
	<div class="content-box">
	  <div class="content-box-header">
        <h3><%if(u.getUserGroup_id()==3){ %>店内推荐<%}else{ %>待机图片<%} %></h3>
            ...
            <%
             ...
             %>
				<tr>
					...
					<td><a <%=bool_ad1 ? "href=\"xx\"":"" %> title="Delete" onclick="<%=bool_ad1 ? "deleteAD("+ad1.get(index_ad1).getAdPicture_id()+",'1');return false;":""%>"><img src="<%=bool_ad1 ? "../../resources/images/icons/cross.png" :"temp2.png" %>" alt="Delete" /></a> </td>
					<% index_ad1++; bool_ad1 = index_ad1 < ad1.size(); %>
					<td><img src="<%=bool_ad1 ? filePath+ad1.get(index_ad1).getAdPicture_path() :"temp.png" %>" class="banner"/></td>
					<td><a <%=bool_ad1 ? "href=\"xx\"":"" %> title="Delete" onclick="<%=bool_ad1 ? "deleteAD("+ad1.get(index_ad1).getAdPicture_id()+",'1');return false;":""%>"><img src="<%=bool_ad1 ? "../../resources/images/icons/cross.png" :"temp2.png" %>" alt="Delete" /></a> </td>
				</tr>
            ...
            <%
             ...
             %>
				<tr>
					...
					<td><a <%=bool_ad2 ? "href=\"xx\"":"" %> title="Delete" onclick="<%=bool_ad2 ? "deleteAD("+ad2.get(index_ad2).getAdPicture_id()+",'2');return false;":""%>"><img src="<%=bool_ad2 ? "../../resources/images/icons/cross.png" :"temp2.png" %>" alt="Delete" /></a> </td>
					<% index_ad2++; bool_ad2 = index_ad2 < ad2.size(); %>
					<td><img src="<%=bool_ad2 ? filePath+ad2.get(index_ad2).getAdPicture_path() :"temp.png" %>" class="banner"/></td>
					<td><a <%=bool_ad2 ? "href=\"xx\"":"" %> title="Delete" onclick="<%=bool_ad2 ? "deleteAD("+ad2.get(index_ad2).getAdPicture_id()+",'2');return false;":""%>"><img src="<%=bool_ad2 ? "../../resources/images/icons/cross.png" :"temp2.png" %>" alt="Delete" /></a> </td>
				</tr>
            ...
            <%
             ...
             %>
				<tr>
					...
					<td><a <%=bool_ad3 ? "href=\"xx\"":"" %> title="Delete" onclick="<%=bool_ad3 ? "deleteAD("+ad3.get(index_ad3).getAdPicture_id()+",'3');return false;":""%>"><img src="<%=bool_ad3 ? "../../resources/images/icons/cross.png" :"temp2.png" %>" alt="Delete" /></a> </td>
					<% index_ad3++; bool_ad3 = index_ad3 < ad3.size(); %>
					<td><img src="<%=bool_ad3 ? filePath+ad3.get(index_ad3).getAdPicture_path() :"temp.png" %>" class="banner"/></td>
					<td><a <%=bool_ad3 ? "href=\"xx\"":"" %> title="Delete" onclick="<%=bool_ad3 ? "deleteAD("+ad3.get(index_ad3).getAdPicture_id()+",'3');return false;":""%>"><img src="<%=bool_ad3 ? "../../resources/images/icons/cross.png" :"temp2.png" %>" alt="Delete" /></a> </td>
				</tr>
    ...
    <script type="text/javascript">
		function deleteAD(id,type){
			if(confirm("确定删除？")){
        		location.href="<%=basePath%>admin/controller/deletePicture?id="+id+"&type="+type;
        	}
		};
